    ...
    <div class="white-box m-t-10">
      ...
      <div class="row">
        <div class="col-sm-12 col-xs-12">
          <form action="<?php echo site_url('staff/appointment/create');?>" method="post">
...
<script type="text/javascript">
  ...
  function load_schedule() {
    $.ajax({
      url: '<?php echo site_url('staff/load_schedule_appointment_ajax');?>/' + day,
