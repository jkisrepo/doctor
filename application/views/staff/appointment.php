<?php 
$this->db->where('chamber_id', $this->session->userdata('chamber_id'));
...
<div class="row">
  <div class="col-sm-12">
    <a href="<?php echo site_url('staff/appointment_new');?>" 
...
<script type="text/javascript">
  ...
  function load_appointment_list(selected_date) {
    $.ajax({
      url: '<?php echo site_url('staff/apply_appointment_filter/');?>' + selected_date,
