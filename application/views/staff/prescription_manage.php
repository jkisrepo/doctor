  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="white-box m-t-10">
        ...
        <form action="<?php echo site_url('staff/prescription/manage/' . $row['prescription_id']);?>"
          method="post">
          <div class="row">
            <div class="col-lg-7">
            ...
            ?>
              ...
              <a href = "<?php echo site_url('staff/print_prescription/'.$prescription_id);?>" type="button" class="btn btn-info waves-effect waves-light m-r-10">
...
<script type="text/javascript">
  ...
  function append_blank_entry(selector) {
    $.ajax({
      url: '<?php echo site_url('staff/load_blank_prescription_entry');?>/' + selector,
