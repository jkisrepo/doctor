<div class="row">
  <div class="col-sm-12">
    <a href="<?php echo site_url('doctor/slidercontent');?>" 
      ...
      <i class="fa fa-arrow-left"></i> &nbsp; <?php echo get_phrase('back_to_slider_list');?>
    </a>
  </div>
</div>
<div class="row">
  <div class="col-lg-12">
    <div class="white-box m-t-10">
      ...
      <form action="<?php echo site_url('doctor/slidercontent/create');?>" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="<?php echo get_phrase('tag_title');?>"
                  name="tag_title" value="" id="tag_title">
              </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
              <div class="form-group">
                ...
                placeholder="<?php echo get_phrase('short_description');?>"></textarea>
              </div>
          </div>          
        </div>
        <div class="row">
          <div class="col-md-4">
              ...
              <div class="form-group">
                  <button type="submit" class="btn btn-success waves-effect waves-light">
                      ...
                      <?php echo get_phrase('add_slider_content'); ?>
                  </button>
              </div>
          </div>
        </div>
