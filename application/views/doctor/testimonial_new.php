<div class="row">
  <div class="col-sm-12">
    <a href="<?php echo site_url('doctor/testimonial');?>" 
      ...
      <i class="fa fa-arrow-left"></i> &nbsp; <?php echo get_phrase('back_to_testimonial_list');?>
    </a>
  </div>
</div>
<div class="row">
  <div class="col-lg-12">
    <div class="white-box m-t-10">
      ...
      <form action="<?php echo site_url('doctor/testimonial/create');?>" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="<?php echo get_phrase('user_name');?>"
                  name="user_name" value="" id="user_name">
              </div>
          </div>
        </div>       
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-4">
              <div class="form-group">
                  ...
                  <input type="file" id="user_image" class="dropify" name="user_image"
                         data-default-file="">
              </div>
              <div class="form-group">
                  <button type="submit" class="btn btn-success waves-effect waves-light">
                      <i class="fa fa-save"></i>
                      <?php echo get_phrase('add_testimonial'); ?>
                  </button>
              </div>
          </div>
        </div>
