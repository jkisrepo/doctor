          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="<?php echo site_url('doctor/staff/' . $row['chamber_id']);?>"
                  class="fcbtn btn btn-info btn-outline btn-1d btn-sm">
                  <?php echo get_phrase('manage_staff'); ?>
                </a>

                <button type="button" onclick="delete_chamber('<?php echo $row['chamber_id'];?>')"
...
<script type="text/javascript">
  ...
  function hide_inputs() {
    ...
    function delete_chamber(chamber_id) {
    swal({
      title: "Are you sure?",
      text: "The chamber and it's content will be deleted permanently !",
      type: "warning",
      ...
      swal("Deleted!", "The chamber is deleted", "success");
      setTimeout(function() {
        window.location = "<?php echo site_url('doctor/chamber/delete/');?>" + chamber_id;
      }, 1000);
    });
  }
