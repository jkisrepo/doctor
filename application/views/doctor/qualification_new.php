...
<div class="row">
  <div class="col-lg-12">
    <div class="white-box m-t-10">
      ...
      <form action="<?php echo site_url('doctor/qualification/create');?>" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="<?php echo get_phrase('qualification_title');?>"
                  name="qualification_title" value="" id="qualification_title">
              </div>
          </div>
        </div>       
        <div class="row">
          ...
          <div class="col-md-4">
              ...
              <div class="form-group">
                  <button type="submit" class="btn btn-success waves-effect waves-light">
                      ...
                      <?php echo get_phrase('add_qualification'); ?>
                  </button>
              </div>
          </div>
        </div>
